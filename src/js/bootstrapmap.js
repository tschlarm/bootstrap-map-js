  	...
  	return {
  		...
  		_smartResizer: declare(null, {
			...
			constructor: function (mapDivId, options)
  			...
  			{
  				var s = style.get(e);
  				var p = (parseInt(s.paddingTop) + parseInt(s.paddingBottom)) || 0;
  				var g = (parseInt(s.marginTop) + parseInt(s.marginBottom)) || 0;
  				var b = (parseInt(s.borderTopWidth) + parseInt(s.borderBottomWidth)) || 0;
  				var h = p + g + b;
  				return h;
  			},
